"""yfinance-backed loader for HK/US/KR equity OHLCV data."""
...
def _to_yfinance_symbol(code: str) -> str:
    ...
    Args:
        code: Project symbol, for example ``AAPL.US``, ``700.HK``, or ``005930.KS``.
...
@register
class DataLoader:
    """Fetch HK/US/KR equity bars from Yahoo Finance via yfinance."""
    ...
    def fetch(
        ...
        Args:
            codes: Project symbols such as ``AAPL.US``, ``700.HK``, and ``005930.KS``.
